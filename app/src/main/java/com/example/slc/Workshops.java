...
public class Workshops extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonsubmit = (Button) findViewById(R.id.button15);
        buttonback = (Button) findViewById(R.id.button16);


        Spinner spinner = findViewById(R.id.spinner9);
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.workshops, android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner.setAdapter(adapter);
        spinner.setOnItemSelectedListener(this);

        Spinner spinnerTutor = findViewById(R.id.spinner8);
        ArrayAdapter<CharSequence> adapterTutor = ArrayAdapter.createFromResource(this, R.array.workshops_tutor, android.R.layout.simple_spinner_item);
