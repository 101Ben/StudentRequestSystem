...
public class HsBioChem extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hs_bio_chem);

        num = (EditText) findViewById(R.id.editText12);
        this.number = num.getText().toString();


        buttonsubmit = (Button) findViewById(R.id.button14);
        buttonback = (Button) findViewById(R.id.button13);


        Spinner spinner = findViewById(R.id.spinner7);
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.hs_bio_chem, android.R.layout.simple_spinner_item);
